  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline:
          "border dark:border-white/10 bg-white dark:bg-gradient-to-r dark:from-black dark:via-black/95 dark:to-black text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gradient-to-r dark:hover:from-black dark:hover:via-black/80 transition-all duration-300 dark:hover:to-black active:bg-gray-200 dark:active:opacity-90",
        secondary:
