    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      <Card className="w-full max-w-4xl">
        ...
        <CardContent className="space-y-4 text-sm mt-4">
          ...
          <p>
            Your use of the Service is subject to our <Link to="/privacy-policy" className="text-primary hover:underline">Privacy Policy</Link>. We are committed to protecting your data, but you acknowledge no system is 100% secure. Use of the Service is at your own risk.
          </p>
