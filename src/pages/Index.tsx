...
import ThemeBackgroundDrawer, {
  DYNAMIC_OPTIONS,
} from "../components/Settings/ThemeBackgroundDrawer";
...
const Index = () => {
  ...
  useEffect(() => {
    const handleWheel = (e: WheelEvent) => {
      ...
      if (
        document.body.classList.contains("splash-screen-active") ||
        showWelcome
      ) {
        return;
      }
  ...
  const getOrderedWidgets = () => {
    const widgets = [
      ...
      {
        type: "todoList",
        position: widgetPositions.todoList,
        component: TodoList,
      },
      {
        type: "pomodoro",
        position: widgetPositions.pomodoro,
        component: Pomodoro,
      },
  ...
  const handleBackgroundTypeChange = (
    type: "image" | "gradient" | "solid" | "dynamic"
  ) => {
